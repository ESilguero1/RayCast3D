...
// Modification of DrawBitmap to allow for 'transparent' rendering so images don't have to be rectangular
void ST7735_DrawBitmapTransparent(int16_t x, int16_t y, const uint16_t *image, int16_t w, int16_t h, uint16_t transparentColor);
