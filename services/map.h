...
/**
 * @brief Load a map from a constant 2D array.
 *
 * Copies the given 24x24 tile array into the active world grid.
 * Use the map arrays exported by RayCast3D Studio in maps.h
 * (e.g., @c map1, @c map2).
 *
 * @param map  2D array of tile values (MAP_HEIGHT x MAP_WIDTH)
 */
 ...
 *
 * Equivalent to @c Map_Load(maps[index]). The @c mapList array in
 * maps.h is auto-generated by RayCast3D Studio and contains pointers
 * to all exported maps.
 *
 * @param maps   Array of map pointers (e.g., @c mapList from maps.h)
